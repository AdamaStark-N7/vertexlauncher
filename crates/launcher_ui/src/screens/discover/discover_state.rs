...
pub struct DiscoverState {
    ...
    pub(crate) search_results: launcher_runtime::WorkerChannel<DiscoverSearchResult>,
    ...
    pub(crate) detail_version_results: launcher_runtime::WorkerChannel<DiscoverVersionsResult>,
...
impl Default for DiscoverState {
    fn default() -> Self {
        Self {
            ...
            detail_version_results: Default::default(),
...
impl DiscoverState {
    ...
    pub fn purge_inactive_state(&mut self) {
        ...
        self.detail_version_results.reset();
        self.install_in_flight = false;
